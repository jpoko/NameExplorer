    ...
    tagList(
        layout_sidebar(
            ...
            sidebar = accordion(
                ...
                accordion_panel(
                    title = "How to use",
                    p("Main navigation is at the top. Switch between light/dark
                      mode by clicking on the sun/moon."),
                    p("What is found on each page:"),
          
          p(strong("Explore")),
          p("Explore names by: overall popularity, popularity by year,
          starting letter(s), contains letter(s), number of letters."),
          
          p(strong("Plot")),
          p("Enter a name to view a plot showing the number of babies born each year who were given that name."),
          
          p(strong("General trends")),
          p("View general U.S. naming trends."),
          
                ),
          
          accordion_panel(
              title = "Recommendations",
              p("If you are interested in finding names, start with", strong("'Explore'.")),
              p("If you have a name and want to see how popular, or not, the name has been over time, start with", strong("'Plot'.")),
              p("If you are curious about naming trends in the U.S., start with", strong("'General trends'."))
        ...
        ## If accordion on bottom (not side)
